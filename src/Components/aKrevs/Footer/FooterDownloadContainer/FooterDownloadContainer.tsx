...
const FooterDownloadContainer = () => {
    ...
    let appleSpecial;
    let androidSpecial;
    let smartTvBtnSpecial;
    let allDevicesSpecial;

    if (isRussian) {
        appleSpecial = 'Загрузить в';
        androidSpecial = 'Доступно в';
        smartTvBtnSpecial = 'Смотрите на';
        allDevicesSpecial = 'Все устройства';
    } else {
        appleSpecial = 'Download to';
        androidSpecial = 'Available in';
        smartTvBtnSpecial = 'Look at';
        allDevicesSpecial = 'All devices';
    }
