        ...
        <div className={[classes.mainContainer, currentColor].join(' ')}>
            ...
            <div className={classes.descriptionTextContainer}>
                ...
                <div className={classes.descriptionItem}>
                    <div className={classes.name}>Кревс Илья</div>
                    <div className={classes.socialItem}>
                        <div className={classes.socialIcon}>
                            {ghIcon}
                        </div>
                        https://github.com/IlyaKrevs
                    </div>
                ...
                <div className={classes.descriptionItem}>
                    <div className={classes.name}>Носаченко Артём</div>
                    <div className={classes.socialItem}>
                        <div className={classes.socialIcon}>
                            {ghIcon}
                        </div>
                        https://github.com/Keronon
                    </div>
                ...
                <div className={classes.descriptionItem}>
                    <div className={classes.name}>Черепаха Севиль</div>
                    <div className={classes.socialItem}>
                        <div className={classes.socialIcon}>
                            {ghIcon}
                        </div>
                        https://github.com/Sivilenok
                    </div>
                ...
                <div className={classes.descriptionItem}>
                    <div className={classes.name}>Лямина Ирина</div>
                    <div className={classes.socialItem}>
                        <div className={classes.socialIcon}>
                            {ghIcon}
                        </div>
                        https://github.com/vivir-para-volar
                    </div>
